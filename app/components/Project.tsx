  ...
  return (
    <div className="grid grid-rows-8 grid-cols-4 gap-5 pb-4 overflow-hidden">
      ...
      <Card
        ...
        } lg:row-start-3 lg:row-end-4 lg:max-h-24 opacity-0 mobile-animation websiteUrlCard`}
      >
        <Link
          href={websiteUrl || "#"}
      ...
      <Card
        ...
        } lg:row-start-3 lg:row-end-4 lg:max-h-24 opacity-0 mobile-animation githubUrlCard`}
      >
        <Link
          href={githubUrl || "#"}
          rel="noopener noreferrer"
